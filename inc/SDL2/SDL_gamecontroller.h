...
/**
 * Load a set of Screen Controller mappings from a seekable SDL data stream.
 *
...
/**
 * Get the current mapping of a Screen Controller.
 *
 * The returned string must be freed with SDL_free().
 *
...
/**
 * Get the Joystick ID from a Screen Controller.
 *
...
/**
 * Query or change current state of Screen Controller events.
 *
...
/**
 * Update a game controller's LED emissionColor.
 *
 * \param gamecontroller The controller to update
